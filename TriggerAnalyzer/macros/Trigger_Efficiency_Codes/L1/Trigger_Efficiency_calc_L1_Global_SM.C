...
void Trigger_Efficiency_calc_L1_Global_SM( int maxNentries=-1, int Njobs=1, int jobN=1 ) {
  ...
  for (Long64_t ievt=0; ievt<chain->GetEntries();ievt++) {    //Long64_t
        ...
        // Single Electron Event Selection (require exactly 1 offline muon as well)
        if(nele_tight == 1){
