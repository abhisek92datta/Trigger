...
void Trigger_Efficiency_calc_HLT_JetHTLeg_EG( int maxNentries=-1, int Njobs=1, int jobN=1 ) {
 ...
 fin.close();
  ...
  TH1::SetDefaultSumw2();
	...
	TEfficiency* Eff_ele_pt_ele27 = new TEfficiency("Eff_ele_pt_ele27","Efficiency vs Electron pT for Ele27;Electron pT (GeV);Efficiency",50,0,400);
    ...
    TEfficiency* Eff_ele_pt_ele32 = new TEfficiency("Eff_ele_pt_ele32","Efficiency vs Electron pT for Ele32;Electron pT (GeV);Efficiency",50,0,400);
    ...
    TEfficiency* Eff_ele_pt_ele32_l1eg = new TEfficiency("Eff_ele_pt_ele32_l1eg","Efficiency vs Electron pT for Ele32_l1eg;Electron pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_ele_pt_ele35 = new TEfficiency("Eff_ele_pt_ele35","Efficiency vs Electron pT for Ele35;Electron pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_ele_pt_ele30_jet35 = new TEfficiency("Eff_ele_pt_ele30_jet35","Efficiency vs Electron pT for Ele30_Jet35;Electron pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_jet_pt_ele30_jet35 = new TEfficiency("Eff_jet_pt_ele30_jet35","Efficiency vs Leading Jet pT for Ele30_Jet35;Leading Jet pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_ht_ele30_jet35 = new TEfficiency("Eff_ht_ele30_jet35","Efficiency vs HT for Ele30_Jet35;HT (GeV);Efficiency",75,0,1000);
	...
	TEfficiency* Eff_ele_pt_ele28_ht150 = new TEfficiency("Eff_ele_pt_ele28_ht150","Efficiency vs Electron pT for Ele28_HT150;Electron pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_jet_pt_ele28_ht150 = new TEfficiency("Eff_jet_pt_ele28_ht150","Efficiency vs Leading Jet pT for Ele28_HT150;Leading Jet pT (GeV);Efficiency",50,0,400);
	...
	TEfficiency* Eff_ht_ele28_ht150 = new TEfficiency("Eff_ht_ele28_ht150","Efficiency vs HT for Ele28_HT150;HT (GeV);Efficiency",75,0,1000);
  ...
  for (Long64_t ievt=0; ievt<chain->GetEntries();ievt++) {    //Long64_t
	    ...
	    if( pass_HLT_Ele27_WPTight_Gsf != 1 && pass_HLT_Ele32_WPTight_Gsf != 1 && pass_HLT_Ele35_WPTight_Gsf != 1 && pass_HLT_Ele38_WPTight_Gsf != 1 && pass_HLT_Ele40_WPTight_Gsf != 1 )
		  continue;
        ...
        for(unsigned int i=0; i<ele_pt.size(); i++) {
            ...
            if(ele_pt[i] > 15 && fabs(ele_eta[i]) < 2.4 && !inCrack && ele_is_ID_Tight[i] == 1) {
                nele_loose++;
                if(ele_pt[i] > 50 && fabs(ele_eta[i]) < 2.1) {
                    nele_tight++;
            ...
            if( nele_loose == 1 ){
                if(njets >= 1){
					...
					for(unsigned int l=0; l<eta_trigger_object.size(); l++){
						...
						int check_filter_label_ref = 0;
						if (check_filter_label( filter_trigger_object[l] , "hltEle35noerWPTightGsfTrackIsoFilter" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltEle38noerWPTightGsfTrackIsoFilter" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltEle40noerWPTightGsfTrackIsoFilter" ) == 1)
							check_filter_label_ref = 1;

						//ele_label1_match = check_filter_label( filter_trigger_object[l] , "hltEle30erJetC34WPTightGsfTrackIsoFilter" ) * check_filter_label_ref;
						ele_label1_match = check_filter_label_ref;
						...
						//ele_label2_match = check_filter_label( filter_trigger_object[l] , "hltEle28erHTT100WPTightGsfTrackIsoFilter" ) * check_filter_label_ref;
						ele_label2_match = check_filter_label_ref;
					...
					if(pass_HLT_Ele27_WPTight_Gsf != -1 && prescale_HLT_Ele27_WPTight_Gsf != 0 && ele_sig1_hlt_match == 1){
						N_e_den11++;
						no_overlap = 1;
                    ...
                    if(pass_HLT_Ele32_WPTight_Gsf != -1 && prescale_HLT_Ele32_WPTight_Gsf != 0 && ele_sig1_hlt_match == 1){
                        N_e_den33++;
                        no_overlap = 1;
                    ...
                    if(pass_HLT_Ele32_WPTight_Gsf_L1DoubleEG != -1 && prescale_HLT_Ele32_WPTight_Gsf_L1DoubleEG != 0 && ele_sig1_hlt_match == 1){
                        N_e_den44++;
                        no_overlap = 1;
					...
					if(pass_HLT_Ele35_WPTight_Gsf != -1 && prescale_HLT_Ele35_WPTight_Gsf != 0 && ele_sig1_hlt_match == 1){
						N_e_den22++;
						no_overlap = 1;
					...
					if(pass_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned != -1 && prescale_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned != 0 && ele_sig1_hlt_match == 1 ){
						...
						*/
						...
						//int pass_ele30_jet35 = pass_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned * jet_sig1_hlt_match * no_overlap;
						int pass_ele30_jet35 = jet_sig1_hlt_match * no_overlap;
					...
					if(pass_HLT_Ele28_eta2p1_WPTight_Gsf_HT150 != -1 && prescale_HLT_Ele28_eta2p1_WPTight_Gsf_HT150 != 0 && ele_sig2_hlt_match == 1){

						N_e_den2++;

						int pass_ele28_ht150 = pass_HLT_Ele28_eta2p1_WPTight_Gsf_HT150 * jet_sig2_hlt_match;
