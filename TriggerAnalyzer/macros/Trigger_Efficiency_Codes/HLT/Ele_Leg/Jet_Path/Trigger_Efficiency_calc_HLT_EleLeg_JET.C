...
void Trigger_Efficiency_calc_HLT_EleLeg_JET( int maxNentries=-1, int Njobs=1, int jobN=1 ) {
  ...
  for (Long64_t ievt=0; ievt<chain->GetEntries();ievt++) {    //Long64_t
	    ...
	    //if( pass_HLT_PFJet40 != 1 && pass_HLT_PFJet60 != 1 && pass_HLT_PFJet80 != 1 && pass_HLT_PFJet140 != 1 && pass_HLT_PFJet200 != 1 && pass_HLT_PFJet260 != 1 && pass_HLT_PFJet320 != 1 && pass_HLT_PFJet400 != 1 && pass_HLT_PFJet450 != 1 && pass_HLT_PFJet500 != 1 && pass_HLT_PFJet550 != 1 )
		if(  pass_HLT_PFJet140 != 1 && pass_HLT_PFJet200 != 1 && pass_HLT_PFJet260 != 1 && pass_HLT_PFJet320 != 1 && pass_HLT_PFJet400 != 1 && pass_HLT_PFJet450 != 1 && pass_HLT_PFJet500 != 1 )
		  continue;
        ...
        if(nele_tight == 1){
            if( nele_loose == 1 ){
                if(njets >= 1 && leading_jet_pt > 70){
					...
					int ele_jet_dR_match_index = 0;
					int ele_jet_sig_hlt_match = 0;
					...
					for(unsigned int l=0; l<eta_trigger_object.size(); l++){
						...
						if (check_filter_label( filter_trigger_object[l] , "hltSinglePFJet140" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet200" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet260" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet320" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet400" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet450" ) == 1 || check_filter_label( filter_trigger_object[l] , "hltSinglePFJet500" ) == 1)
							check_filter_label_ref = 1;

						//jet_label1_match = check_filter_label( filter_trigger_object[l] , "hltEle30PFJet35EleCleaned" );
						jet_label1_match = check_filter_label_ref;
						...
						if (jet_label1_match == 1){
							...
							if( dR < 0.3 ){
								if( dR < dR_min5){
									ele_jet_dR_match_index = l;
									ele_jet_sig_hlt_match = 1;
									dR_min5 = dR;
								}
							}
						}

						 //jet_label2_match = check_filter_label( filter_trigger_object[l] , "hltPFHT150Jet30" );
						 jet_label2_match = check_filter_label_ref;
						 if (jet_label2_match == 1){
							dR = dR_calc(leading_jet_eta, leading_jet_phi, eta_trigger_object[l], phi_trigger_object[l]);
							if( dR < 0.3 ){
								if( dR < dR_min4){
									jet_dR2_match_index = l;
					...
					int no_overlap = 0;
					//ele_jet_sig_hlt_match = 0;

					if(pass_HLT_Ele27_WPTight_Gsf != -1 && prescale_HLT_Ele27_WPTight_Gsf != 0 && ele_jet_sig_hlt_match == 0){
						N_e_den11++;
						no_overlap = 1;
                    ...
                    if(pass_HLT_Ele32_WPTight_Gsf != -1 && prescale_HLT_Ele32_WPTight_Gsf != 0 && ele_jet_sig_hlt_match == 0){
                        N_e_den33++;
                        no_overlap = 1;
                    ...
                    if(pass_HLT_Ele32_WPTight_Gsf_L1DoubleEG != -1 && prescale_HLT_Ele32_WPTight_Gsf_L1DoubleEG != 0 && ele_jet_sig_hlt_match == 0){
                        N_e_den44++;
                        no_overlap = 1;
					...
					if(pass_HLT_Ele35_WPTight_Gsf != -1 && prescale_HLT_Ele35_WPTight_Gsf != 0 && ele_jet_sig_hlt_match == 0){
						N_e_den22++;
						no_overlap = 1;
					...
					if(pass_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned != -1 && prescale_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned != 0 && jet_sig1_hlt_match == 1 && ele_jet_sig_hlt_match == 0 ){
					...
					if(pass_HLT_Ele28_eta2p1_WPTight_Gsf_HT150 != -1 && prescale_HLT_Ele28_eta2p1_WPTight_Gsf_HT150 != 0 && jet_sig2_hlt_match == 1 && ele_jet_sig_hlt_match == 0){
